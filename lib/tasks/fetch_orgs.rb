...
module Tasks
  class FetchOrgs
    OBJECT_URL = ENV.fetch(
      "FETCH_ORGS_OBJECT_URL",
      "https://govwifi-production-product-page-data.s3.eu-west-2.amazonaws.com/organisations.yml"
    ).freeze
    OUTPUT_PATH = File.expand_path("../../data/organisations.yml", __dir__).freeze 
